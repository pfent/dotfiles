...
# set to 0 to disable display of code region around the current instruction
set $SHOWCODE = 0
# set to 0 to disable display of local variables on each step
set $SHOWLOCALS = 0
...
#set print elements number-of-elements 3 # TODO
...
define locals-on
    set $SHOWLOCALS = 1
    printf "Displaying of loal variables is now ON\n"
end
document locals-on
Syntax: locals-on
| Enable display of local variables on every program break.
end


define locals-off
    set $SHOWLOCALS = 0
    printf "Displaying of local variables is now OFF\n"
end
document locals-off
Syntax: locals-off
| Disable display of local variables on every program break.
end
